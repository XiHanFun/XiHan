...
namespace XiHan.Utils.Extensions.Collections.Generic;
...
public static class ListExtensions
{
    ...
    public static List<T> SortByDependencies<T>(this IEnumerable<T> source,
        Func<T, IEnumerable<T>> getDependencies, IEqualityComparer<T>? comparer = null)
        where T : notnull
    {
        // 初始化排序列表、访问标记字典
