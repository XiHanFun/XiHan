...
// FileName:BaseCacheService
// Guid:c06dba51-db4f-463f-b81b-176346d51631
// Author:zhaifanhua
// Email:me@zhaifanhua.com
// CreateTime:2024/3/29 4:20:00
// ----------------------------------------------------------------
...
public class BaseCacheService : IBaseCacheService
{
    ...
    public bool Set(string key, object value)
    {
        ...
        _ = _cache.Set(key, SerializeHelper.SerializeTo(value));
        return Exists(key);
    }
    ...
    public bool Set(string key, object value, TimeSpan expiresSliding, TimeSpan expiresAbsolute)
    {
        ...
        _ = _cache.Set(key, SerializeHelper.SerializeTo(value), new MemoryCacheEntryOptions()
    ...
    public bool Set(string key, object value, TimeSpan expiresIn, bool isSliding = false)
    {
        ...
        _ = _cache.Set(key, SerializeHelper.SerializeTo(value), isSliding
    ...
    public bool SetWithSeconds(string key, object value, int seconds)
    {
        ...
        _ = _cache.Set(key, SerializeHelper.SerializeTo(value), DateTime.Now.AddSeconds(seconds));
        return Exists(key);
    }
    ...
    public bool SetWithMinutes(string key, object value, int minutes)
    {
        ...
        _ = _cache.Set(key, SerializeHelper.SerializeTo(value), DateTime.Now.AddMinutes(minutes));
        return Exists(key);
    }
    ...
    public bool Update(string key, object value)
    {
        return key == null
            ...
            : value == null
                ...
                : !Exists(key)
                    ? Set(key, SerializeHelper.SerializeTo(value))
                    : Remove(key) && Set(key, SerializeHelper.SerializeTo(value));
    }
    ...
    public bool Update(string key, object value, TimeSpan expiresSliding, TimeSpan expiresAbsolute)
    {
        return key == null
            ...
            : value == null
                ? throw new ArgumentNullException(nameof(value))
                : !Exists(key)
                    ? Set(key, SerializeHelper.SerializeTo(value), expiresSliding, expiresAbsolute)
                    : Remove(key) && Set(key, SerializeHelper.SerializeTo(value), expiresSliding, expiresAbsolute);
    }
    ...
    public bool Update(string key, object value, TimeSpan expiresIn, bool isSliding = false)
    {
        return key == null
            ...
            : value == null
                ? throw new ArgumentNullException(nameof(value))
                : !Exists(key)
                    ? Set(key, SerializeHelper.SerializeTo(value), expiresIn, isSliding)
                    : Remove(key) && Set(key, SerializeHelper.SerializeTo(value), expiresIn, isSliding);
    }
