...
// FileName:InfrastructureEventBusModuleInitializer
...
namespace XiHan.Infrastructure.EventBus;

/// <summary>
/// 基础设施集成事件模块初始化
/// </summary>
public class InfrastructureEventBusModuleInitializer : IModuleInitializer
{
    /// <summary>
    /// 初始化服务配置
    /// </summary>
