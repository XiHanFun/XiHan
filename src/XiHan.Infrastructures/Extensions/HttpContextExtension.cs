...
public static class HttpContextExtension
{
    ...
    {
        return GetClientIpAddressInfo(httpContext).MapToIPv4().ToString();
    }
    ...
    {
        return GetClientIpAddressInfo(httpContext).MapToIPv6().ToString();
    }
    ...
    public static UserAddressInfo GetAddressInfo(this HttpContext httpContext)
    {
        ...
        var addressInfoResult = IpSearchHelper.Search(GetClientIpV4(httpContext) ?? string.Empty);
