...
public enum ApiGroupNames
{
    ...
    /// 后台接口
    /// </summary>
    [GroupInfo(Title = "后台接口", Description = "这是用于管理的博客后台接口", Version = "v1.0.0-20221117")]
    Backstage,

    /// <summary>
    /// 授权接口
    /// </summary>
    [GroupInfo(Title = "授权接口", Description = "这是用于登录的博客授权接口", Version = "v1.0.0-20221117")]
    Authorize,

    /// <summary>
    /// 公共接口
    /// </summary>
    [GroupInfo(Title = "公共接口", Description = "这是用于常用功能的公共接口", Version = "v1.0.0-20221117")]
    Common,

    /// <summary>
    /// 测试接口
    /// </summary>
    [GroupInfo(Title = "测试接口", Description = "这是用于测试的博客测试接口", Version = "v1.0.0-20221117")]
    Test,
}