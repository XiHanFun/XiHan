...
public static class TestEncryption
{
    ...
    public static void EncryptionAes()
    {
        ...
        var strAes1 = plainText != null && password1 != null ? AesEncryptionHelper.Encrypt(plainText, password1) : throw new ArgumentNullException();
        ...
        var strAes2 = cipherText != null && password2 != null ? AesEncryptionHelper.Decrypt(cipherText, password2) : throw new ArgumentNullException();
    ...
    public static void EncryptionSha()
    {
        ...
        var strSha256 = plainText != null ? ShaHashEncryptionHelper.Sha256(plainText) : throw new ArgumentNullException();
        var strSha384 = plainText != null ? ShaHashEncryptionHelper.Sha384(plainText) : throw new ArgumentNullException();
        var strSha512 = plainText != null ? ShaHashEncryptionHelper.Sha512(plainText) : throw new ArgumentNullException();
    ...
    public static void EncryptionRsa()
    {
        ...
        if (encryptedText == null) throw new ArgumentNullException();
