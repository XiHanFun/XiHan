...
using XiHan.Main.Consoles;
using XiHan.Web.Setups;
...
try
{
    ...
    app.UseApplicationSetup(app.Environment, () => Assembly.GetExecutingAssembly().GetManifestResourceStream("XiHan.Main.index.html")!);
