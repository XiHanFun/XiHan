...
// FileName:SnowWorkerM1
// Guid:62dbd7e6-91d4-4bab-ac6e-b9b6c7e9655c
// Author:zhaifanhua
// Email:me@zhaifanhua.com
// CreateTime:2023/7/12 23:30:24
// ----------------------------------------------------------------
...
#pragma warning restore CS8602 // 解引用可能出现空引用。
    ...
    private void BeginOverCostAction(in long useTimeTick)
    {
        ...
        DoGenIdAction(new OverCostActionArg(WorkerId, useTimeTick, 1, _OverCostCountInOneTerm, _GenCountInOneTerm, _TermIndex));
    }
    ...
    private void EndOverCostAction(in long useTimeTick)
    {
        ...
        DoGenIdAction(new OverCostActionArg(WorkerId, useTimeTick, 2, _OverCostCountInOneTerm, _GenCountInOneTerm, _TermIndex));
    }
    ...
    private void BeginTurnBackAction(in long useTimeTick)
    {
        ...
        DoGenIdAction(new OverCostActionArg(WorkerId, useTimeTick, 8, 0, 0, _TurnBackIndex));
    }
    ...
    private void EndTurnBackAction(in long useTimeTick)
    {
        ...
        DoGenIdAction(new OverCostActionArg(WorkerId, useTimeTick, 9, 0, 0, _TurnBackIndex));
    }
