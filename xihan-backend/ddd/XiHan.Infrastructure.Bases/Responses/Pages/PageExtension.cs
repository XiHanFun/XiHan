...
public static class PageExtension
{
    ...
    public static List<TEntity> ToPageList<TEntity>(this IEnumerable<TEntity> entities, PageDto pageDto,
        int defaultFirstIndex = 1) where TEntity : class, new()
    {
        return entities.Skip((pageDto.CurrentIndex - defaultFirstIndex) * pageDto.PageSize)
        ...
        int pageSize) where TEntity : class, new()
    {
        ...
        {
            PageResponse = new PageResponseDto(currentIndex, pageSize, entities.Count())
        };
        return pageDataDto;
    }
        ...
        where TEntity : class, new()
    {
        PageDataDto<TEntity> pageDataDto = new()
        {
            PageResponse = new PageResponseDto(pageDto.CurrentIndex, pageDto.PageSize, entities.Count())
        };
        return pageDataDto;
    }
        ...
        int pageSize, int defaultFirstIndex = 1) where TEntity : class, new()
    {
        ...
        {
            PageResponse = new PageResponseDto(currentIndex, pageSize, entities.Count),
            Datas = entities.ToPageList(currentIndex, pageSize, defaultFirstIndex)
        };
        return pageDataDto;
    }
        ...
        int defaultFirstIndex = 1) where TEntity : class, new()
    {
        ...
        {
            PageResponse = new PageResponseDto(pageDto.CurrentIndex, pageDto.PageSize, entities.Count),
            Datas = entities.ToPageList(pageDto, defaultFirstIndex)
        };
        return pageDataDto;
    }
        ...
        where TEntity : class, new()
    {
        ...
        pageDataDto.PageResponse.CurrentIndex = 1;
        pageDataDto.PageResponse.TotalCount = pageDataDto.Datas.Count;
        pageDataDto.PageResponse.PageSize = pageDataDto.PageResponse.TotalCount;
        pageDataDto.PageResponse.PageCount = 1;
        return pageDataDto;
    }
