...
public static class DiskInformationTest
{
    ...
    public static void DiskInformation()
    {
        ...
        Console.WriteLine(
            $@"【D:\DataMine\Repository\XiHan-Backend\README.md】文件大小：{FormatExtension.FormatFileSizeToString(FileHelper.GetFileSize(@"D:\DataMine\Repository\XiHan-Backend\README.md"))}；");
