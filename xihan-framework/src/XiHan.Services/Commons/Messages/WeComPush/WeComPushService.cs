...
public class WeComPushService : BaseService<SysRobot>, IWeComPushService
{
    ...
    {
        SysRobot sysCustomRobot = await GetFirstAsync(e => e.IsEnabled && e.RobotType == RobotTypeEnum.WeCom);
    ...
    /// <returns></returns>
    public async Task<ApiResult> WeComToUploadFile(FileStream fileStream)
    {
