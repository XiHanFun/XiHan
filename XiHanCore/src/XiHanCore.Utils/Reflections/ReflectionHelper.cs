...
namespace XiHanCore.Utils.Reflections;
...
public static class ReflectionHelper
{
    ...
    /// <returns></returns>
    public static IEnumerable<Assembly> GetAllEffectiveAssemblies(string prefix = "XiHanCore", string suffix = "dll")
    {
    ...
    public static List<NuGetPackage> GetInstalledNuGetPackages()
    {
        ...
        foreach (var assembly in assemblies)
        {
            var referencedAssemblies = assembly.GetReferencedAssemblies()
                ...
                .Where(s => !s.FullName.StartsWith("XiHanCore"));
