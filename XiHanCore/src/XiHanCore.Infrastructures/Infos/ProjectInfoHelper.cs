...
namespace XiHanCore.Infrastructures.Infos;
...
╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝";
    ...
    /// 官方组织
    /// </summary>
    public static string OfficialOrganization => $@"https://github.com/XiHanCoreFun";

    /// <summary>
    /// 源码仓库
    /// </summary>
    public static string SourceCodeRepository => $@"https://github.com/XiHanCoreFun/XiHanCore.Framework";
}