...
using XiHanCore.Infrastructures.Apps;
using XiHanCore.Infrastructures.Apps.HttpContexts;
using XiHanCore.Infrastructures.Responses;
using XiHanCore.Models.Syses;
using XiHanCore.Models.Syses.SeedData;
using XiHanCore.Utils.Extensions;
using XiHanCore.Utils.Serializes;
using XiHanCore.WebCore.Common.Swagger;
using XiHanCore.WebCore.Filters;

namespace XiHanCore.WebHost.Controllers.Tests;
...
public class TestController : BaseApiController
{
    ...
    {
        var path = @"E:\Repository\XiHanCoreFun\Other\架构设计\系统设计\日志管理\image-20210409150248593.png";
